  ...
  return (
    <>
      <div className="content-center">
        <input
          className="border-2 border-gray-300 bg-white h-10 px-5 pr-5 rounded-lg focus:outline-none"
          type="search"
          name="search"
        ...
        ></input>
        <button
          className="bg-green-400 hover:bg-green-500 text-white font-bold py-2 px-2 rounded-full"
          onClick={() => {
            fetchStockNames()
            setSearchQuery('')
          }}
